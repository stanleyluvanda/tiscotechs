...
/>
  ...
  {logo && (
    ...
    <div className="overflow-hidden border-y border-slate-200 bg-white shadow-sm sm:rounded-lg sm:border">
      <img
        src={logo}
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <h3 className="text-base font-semibold -mx-5 -mt-5 mb-4">
          <span className="block w-full sm:rounded-lg bg-gradient-to-r from-orange-500 to-amber-500 py-2.5 text-center text-white">
            At a glance
          </span>
        </h3>
