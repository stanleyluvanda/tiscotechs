...
import { GraduationCap, Mail, Globe2 } from "lucide-react";
...
<section className="relative w-full overflow-hidden bg-[#eaf7ff]">
  ...
  <div className="absolute bottom-[7%] left-[5.7%]">
    ...
    >
      ...
      {/* CTA */}
<section className="w-full mt-0">
  <div className="bg-gradient-to-r from-[#083b82] via-[#0A4595] to-[#1a73e8] text-white shadow-md">
    <div className="mx-auto grid max-w-[1520px] gap-10 px-4 py-14 sm:px-8 lg:grid-cols-[1fr_2fr_1fr] lg:items-center lg:gap-10">

      {/* Left: ScholarsKnowledge */}
      <div className="text-left">
        ...
        <div className="mt-6 space-y-3 text-sm text-blue-100">
          ...
          >
            <Mail size={17} className="text-blue-200" />
            support@scholarsknowledge.com
          </a>

          <div className="flex items-center gap-3">
            <Globe2 size={17} className="text-blue-200" />
      ...
      <div className="text-center">
        ...
        <p className="mt-3 mx-auto max-w-2xl text-white/90">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <Link
            to="/student-sign-up"
            className="rounded-full bg-white px-5 py-2 font-semibold text-[#0A4595] hover:bg-slate-100"
          >
            Student Sign Up
          </Link>
          ...
          <Link
            to="/lecturer-sign-up"
            className="rounded-full border border-white px-5 py-2 font-semibold text-white hover:bg-[#0a3d83]"
          >
            Lecturer Sign Up
          </Link>
          ...
          <Link
            to="/partner"
            className="rounded-full bg-[#fbbc04] px-5 py-2 font-semibold text-slate-900 hover:opacity-90"
          >
            Partner with Us
          </Link>
        </div>
      ...
      <div className="text-left lg:pl-6">
        ...
        <nav className="mt-5 space-y-3 text-sm text-blue-100">
          <Link
            to="/scholarships"
