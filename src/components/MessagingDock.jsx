  ...
  return (
    <div className="flex items-center justify-between gap-2">
      ...
      {chatOpen && active && (
        ...
        <div className="fixed bottom-3 left-3 right-3 sm:bottom-4 sm:left-auto sm:right-[485px] z-50 w-auto sm:w-[650px] h-[calc(100vh-205px)] sm:h-[540px] bg-white shadow-2xl border border-slate-200 rounded-xl overflow-hidden flex flex-col">
    ...
    {(m.attachments || []).map((a, idx) => {
      ...
      return isImage ? (
        ...
        >
          ...
          <div className="border-t border-slate-200 px-3 pt-3 pb-3 sm:p-3 min-h-[150px] sm:min-h-0 flex flex-col justify-end">
