  ...
  return (
    <div className="flex items-center justify-between gap-2">
      ...
      {chatOpen && active && (
        ...
        <div className="fixed bottom-3 left-3 right-3 sm:bottom-4 sm:left-auto sm:right-[485px] z-50 w-auto sm:w-[650px] h-[calc(100vh-165px)] sm:h-[540px] bg-white shadow-2xl border border-slate-200 rounded-xl overflow-hidden flex flex-col">
